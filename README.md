...
Finish date: 28/5/2026<br>
Time taken: 18+ hrs.<br>
...
### Technical Growth
- Understanding the difference between the integration and unit tests in the context of APIs.
  - Unit testing: refers to testing individual "units" of code. the code meaning parts that doesn't touch the HTTP requests

### Challenges & Engineering Decisions
- The choice to change the registry from docker hub to GitHub Container Registry (GHCR) due to the storage and ease of use since I am using GitHub already.
- 
